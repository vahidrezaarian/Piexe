    ...
    public static class CustomIcons
    {
        public static DrawingImage Copy
        {
            get
            {
                ...
                var drawing1 = new GeometryDrawing(Brushes.White, null, geometry1);
                ...
                var drawing2 = new GeometryDrawing(Brushes.White, null, geometry2);
        ...
        public static DrawingImage Copied
        {
            get
            {
                ...
                var geometry1 = Geometry.Parse(
                    "M17.0998 2H12.8998C9.81668 2 8.37074 3.09409 8.06951 5.73901C8.00649 6.29235 8.46476 6.75 9.02167 6.75H11.0998C15.2998 6.75 17.2498 8.7 17.2498 12.9V14.9781C17.2498 15.535 17.7074 15.9933 18.2608 15.9303C20.9057 15.629 21.9998 14.1831 21.9998 11.1V6.9C21.9998 3.4 20.5998 2 17.0998 2Z");
                var drawing1 = new GeometryDrawing(Brushes.SpringGreen, null, geometry1);
                drawingGroup.Children.Add(drawing1);
                ...
                var drawing2 = new GeometryDrawing(Brushes.SpringGreen, null, geometry2);
                drawingGroup.Children.Add(drawing2);
        ...
        public static DrawingImage Barcode
        {
            get
            {
                ...
                var mainDrawing = new GeometryDrawing(Brushes.White, null, mainGeometry);
        ...
        public static DrawingImage OpenFolder
        {
            get
            {
                ...
                drawingGroup.Children.Add(new GeometryDrawing(Brushes.White, null, bottomGeometry));
                ...
                drawingGroup.Children.Add(new GeometryDrawing(Brushes.White, null, topGeometry));
                var drawingImage = new DrawingImage(drawingGroup);
                drawingImage.Freeze();
                return drawingImage;
            }
        ...
        public static DrawingImage PictureFrame
        {
            get
            {
                ...
                var drawing3 = new GeometryDrawing(Brushes.White, null, geometry3);
        ...
        public static DrawingImage PictureScan
        {
            get
            {
                ...
                var drawing4 = new GeometryDrawing(Brushes.White, null, geometry4);
                ...
                var drawing5 = new GeometryDrawing(Brushes.White, null, geometry5);
                ...
                var drawing6 = new GeometryDrawing(Brushes.White, null, geometry6);
                ...
                var drawing7 = new GeometryDrawing(Brushes.White, null, geometry7);
